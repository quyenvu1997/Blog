    ...
    ****************************************************************** --> 
    ...
    <header class="tada-container">
    	...
    	<nav class="menu-desktop menu-sticky">
            ...
            <ul class="tada-menu">
                     <li><a href="{{ asset('/user/home') }}" class="active">HOME{{-- <i class="icon-arrow-down8"> --}}</i></a>
                        {{-- <ul class="submenu">
                    ...
                    <li><a href="#">CATEGORIES <i class="icon-arrow-down8"></i></a>
                        <ul class="submenu">
                            @foreach ($categories as $row)
                                ...
                                <li><a href="{{ asset('user/categories/') }}/{{$row->slug}}" title="">{{$row->name}}</a></li>
                                <li></li>
                            @endforeach
                    ...
                    {{-- <li><a href="#">BLOG <i class="icon-arrow-down8"></i></a>
                     ...
                     <li><a href="about-us.html">TAG<i class="icon-arrow-down8"></i></a>
                        <ul class="submenu">
                            @foreach ($tags as $tag)
                                <li><a href="{{ asset('user/tags/') }}/{{$tag->slug}}" title="">{{$tag->name}}</a></li>
                            @endforeach                                                
                        </ul> 
                    </li>
                    <li><a href="{{ asset('/user/contact') }}">CONTACT</a></li>
    ...
    <div class="sidebar col-xs-4">
        ...
        <div class="widget tags">
            ...
            <div class="tags-container">
                @foreach ($tags as $tag)
                    <a href="{{ asset('user/tags/') }}/{{$tag->slug}}" title="">{{$tag->name}}</a>
                @endforeach                                    
            </div>
            <div class="clearfix"></div>
        </div> 
