...
<div class="container-fluit">
	<form action="/admin/posts/update/{{$post->id}}" method="POST" class="" role="form" enctype="multipart/form-data">
		@csrf
		<div class="row">
			<div class="col-8">
			...
			<div class="col-4">
				...
				<div class="rounded border border-muted">
					...
					<input type="text" name="tag" class="form-control" placeholder="các tag cách nhau bởi dấu phẩy" value="@foreach ($post->tags as $tag){{$tag->name}},@endforeach">	
